Note: My sample is adapted from https://github.com/Azure-Samples/active-directory-angularjs-singlepageapp  
These instructions are for running the original code, and are only included here for crediting the original work. They are not relevant for the changes in this repo.

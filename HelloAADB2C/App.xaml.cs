...
namespace HelloAADB2C
{
    ...
    {
        //Replace Tenant & ClientId with values specific to you
        private static string Tenant = "contosob2c.onmicrosoft.com";
        private static string ClientId = "copy-from-Azure-Portal";
        //Make sure your policies either have these names, or rename the variables accordingly
        public static string PolicySignUpSignIn = "B2C_1A_SignUpOrSignInWithAAD";
